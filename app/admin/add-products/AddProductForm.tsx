...
const AddProductForm = () => {
  ...
  const [images, setImages] = useState<ImageTypeProps[] | null>();
  ...
  const addImageToState = useCallback((value: ImageTypeProps) => {
    setImages((prev) => {
      if (!prev) {
        return [value];
      }
  ...
  const removeImageFromState = useCallback((value: ImageTypeProps) => {
    setImages((prev) => {
      if (prev) {
