...
import { ImageTypeProps } from "@/app/admin/add-products/AddProductForm";
...
interface SelectColorProps {
  item: ImageTypeProps;
  addImageToState: (value: ImageTypeProps) => void;
  removeImageFromState: (value: ImageTypeProps) => void;
